...
{    
    ...
    public class InheritanceTests
    {
        ...
        /// LunchRate
        /// است.
        /// در صورتیکه این کلاس را با اطلاعات بالا به درستی پیاده‌سازی کنید
        /// تست زیر پاس می‌شود
        /// </summary>
        [TestMethod()]
        public void Q12_PersonTest()
        {
            // Assert.Inconclusive();
